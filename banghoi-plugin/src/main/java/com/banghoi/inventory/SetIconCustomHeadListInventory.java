...
import com.banghoi.file.inventory.SetIconCustomHeadListInventoryFile;
import com.banghoi.language.Messages;
import com.banghoi.storage.CustomHeadData;
        ...
        BangHoi.support.getFoliaLib().getScheduler().runAsync(task -> {
            ...
            for (int i = 0; i < getMaxItemsPerPage(); i++) {
                ...
                if (customheads.get(index) != null) {
                    ...
                    ItemStack itemStack = BangHoi.nms.addCustomData(customHeadItem, "value=" + customHeadValue);
