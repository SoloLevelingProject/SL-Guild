...
import com.banghoi.clan.subject.SetSpawn;
import com.banghoi.file.inventory.ClanSettingsInventoryFile;
...
public class ClanSettingsInventory extends BangHoiInventoryBase {
    ...
    public void setMenuItems() {
        BangHoi.support.getFoliaLib().getScheduler().runAsync(task -> {
            ...
            ItemStack setIconItem = BangHoi.nms.addCustomData(ItemUtil.getItem(
            ...
            ItemStack setCustomNameItem = BangHoi.nms.addCustomData(ItemUtil.getItem(
            ...
            ItemStack setMessageItem = BangHoi.nms.addCustomData(ItemUtil.getItem(
            ...
            ItemStack setSpawnItem = BangHoi.nms.addCustomData(ItemUtil.getItem(
            ...
            ItemStack setPermissionItem = BangHoi.nms.addCustomData(ItemUtil.getItem(
            ...
            ItemStack disbandItem = BangHoi.nms.addCustomData(ItemUtil.getItem(
