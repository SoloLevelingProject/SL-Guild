...
import com.banghoi.clan.subject.RequestAlly;
import com.banghoi.file.inventory.AddAllyListInventoryFile;
            ...
            for (int i = 0; i < getMaxItemsPerPage(); i++) {
                ...
                if (clans.get(index) != null) {
                    ...
                    if (clanItemItemMeta.getLore() != null) {
                        ...
                        ItemStack itemStack = BangHoi.nms.addCustomData(ItemUtil.getClanItemStack(clanItem, clanData), "request=" + clanName);
