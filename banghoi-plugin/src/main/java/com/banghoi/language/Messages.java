...
public class Messages {
        ...
        public static List<String> COMMAND_BANGHOI_MESSAGES_NON_CLAN;
        public static String COMMAND_BANGHOI_MESSAGES_IN_CLAN;
        public static String COMMAND_BANGHOI_MESSAGES_IN_CLAN_PLACEHOLDER_MEMBERCOMMANDS;
        public static String COMMAND_BANGHOI_MESSAGES_IN_CLAN_PLACEHOLDER_MANAGERCOMMANDS;
        public static String COMMAND_BANGHOI_MESSAGES_IN_CLAN_PLACEHOLDER_LEADERCOMMANDS;
        public static String COMMAND_BANGHOI_MESSAGES_IN_CLAN_PLACEHOLDER_MEMBERCOMMANDS_PLACEHOLDER_COMMAND;
        public static String COMMAND_BANGHOI_MESSAGES_IN_CLAN_PLACEHOLDER_MANAGERCOMMANDS_PLACEHOLDER_COMMAND;
        public static String COMMAND_BANGHOI_MESSAGES_IN_CLAN_PLACEHOLDER_LEADERCOMMANDS_PLACEHOLDER_COMMAND;
        ...
        public static String CONTRIBUTION_DISABLED;
        public static String CONTRIBUTION_SUCCESS_MONEY;
        public static String CONTRIBUTION_ALREADY_TODAY;
        public static String CONTRIBUTION_NOT_ENOUGH_MONEY;
        public static String CONTRIBUTION_MONEY_MAX_REACHED;

        public static void setupValue(String locale) {
                locale = locale.toLowerCase();
                File messageFile = new File(BangHoi.plugin.getDataFolder() + "/languages/language_" + locale + ".yml");
                ...
                CURRENCY_DISPLAY_PLAYERPOINTS_SYMBOL = fileConfiguration
                                .getString("currency-display.PLAYERPOINTS.symbol");
                ...
                TARGET_CLAN_ALLY_MEMBERSHIP_ERROR = fileConfiguration
                                .getString("messages.target-clan-ally-membership-error");
                ...
                CLAN_SET_SPAWN_BLACK_LIST_WORLD = fileConfiguration
                                .getString("messages.clan-set-spawn-black-list-world");
                ...
                USING_CHAT_BOX_CANCEL_USING_CHAT_BOX = fileConfiguration
                                .getString("messages.using-chat-box.cancel-using-chat-box");
                USING_CHAT_BOX_CANCEL_USING_CHAT_BOX_SUCCESS = fileConfiguration
                                .getString("messages.using-chat-box.cancel-using-chat-box-success");
                USING_CHAT_BOX_CANCEL_USING_CHAT_TIME_OUT = fileConfiguration
                                .getString("messages.using-chat-box.time-out");
                USING_SIGN_INPUT_INVENTORY_LIST_SEARCH = fileConfiguration
                                .getString("messages.using-sign-input.inventory-list-search");
                ...
                CLAN_BROADCAST_PLAYER_JOIN_CLAN = fileConfiguration
                                .getString("messages.clan-broadcast.player-join-clan");
                CLAN_BROADCAST_PLAYER_REMOVED_FROM_CLAN = fileConfiguration
                                .getString("messages.clan-broadcast.player-removed-from-clan");
                CLAN_BROADCAST_PLAYER_LEAVE_CLAN = fileConfiguration
                                .getString("messages.clan-broadcast.player-leave-clan");
                CLAN_BROADCAST_PLAYER_REJECT_TO_JOIN = fileConfiguration
                                .getString("messages.clan-broadcast.player-reject-to-join");
                ...
                CLAN_BROADCAST_MEMBER_PROMOTED_TO_OWNER = fileConfiguration
                                .getString("messages.clan-broadcast.member-promoted-to-owner");
                CLAN_BROADCAST_MEMBER_PROMOTED_TO_MANAGER = fileConfiguration
                                .getString("messages.clan-broadcast.member-promoted-to-manager");
                CLAN_BROADCAST_MANAGER_REMOVED = fileConfiguration.getString("messages.clan-broadcast.manager-removed");
                CLAN_BROADCAST_RECEIVE_ALLY_INVITE = fileConfiguration
                                .getString("messages.clan-broadcast.receive-ally-invite");
                CLAN_BROADCAST_NEW_ALLY_NOTIFICATION = fileConfiguration
                                .getString("messages.clan-broadcast.new-ally-notification");
                CLAN_BROADCAST_REMOVE_ALLY_NOTIFICATION = fileConfiguration
                                .getString("messages.clan-broadcast.remove-ally-notification");
                CLAN_BROADCAST_ALLY_REMOVED_NOTIFICATION = fileConfiguration
                ...
                CLAN_BROADCAST_CHANGE_PERMISSION = fileConfiguration
                                .getString("messages.clan-broadcast.change-permission");
                ...
                CONTRIBUTION_NOT_ENOUGH_MONEY = fileConfiguration.getString("messages.contribution.not-enough-money",
                                "&cYou don't have enough money! Required: &e%amount%");
                CONTRIBUTION_MONEY_MAX_REACHED = fileConfiguration.getString("messages.contribution.money-max-reached",
                                "&cBạn đã cống hiến tiền đủ số lần hôm nay!");
