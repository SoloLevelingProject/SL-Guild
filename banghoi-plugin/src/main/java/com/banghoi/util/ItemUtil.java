...
public class ItemUtil {
    ...
    public static ItemStack getItem(ItemType itemType, String value, int customModelData, String name,
        ...
        if (itemType.equals(ItemType.MATERIAL))
            material.set(BangHoi.nms.createItemStack(value, 1, customModelData, glow));
        ...
        if (lore != null) {
            ...
            for (String string : lore)
                newLore.add(BangHoi.nms.addColor(string));
    ...
    public static @NotNull ItemStack getClanItemStack(ItemStack itemStack, IClanData clanData) {
        ...
        itemMeta.setDisplayName(BangHoi.nms.addColor(itemName));

        List<String> itemLore = itemMeta.getLore();
        itemLore.replaceAll(string -> BangHoi.nms.addColor(string
    ...
    public static @NotNull ItemStack getPlayerItemStack(ItemStack itemStack, String playerName) {
        ...
        itemLore.replaceAll(string -> BangHoi.nms.addColor(string
                ...
                .replace("%uuid%",
                        playerData.getUUID() == null ? BangHoi.nms.addColor(Messages.UNKNOWN) : playerData.getUUID())
                ...
                .replace("%onlineStatus%",
                        (onlineStatus ? Messages.ONLINE_STATUS_ONLINE : Messages.ONLINE_STATUS_OFFLINE))
